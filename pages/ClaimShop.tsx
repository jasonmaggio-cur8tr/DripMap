    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-coffee-50">
            <div className="text-center p-8 bg-white rounded-3xl shadow-xl">
                <h2 className="text-2xl font-serif font-bold mb-4">Please Login First</h2>
                <p className="mb-6 text-coffee-600">You need an account to claim a business.</p>
    ...
    <div className="min-h-screen bg-coffee-50 pt-24 pb-10 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-coffee-100">
        <div className="bg-coffee-900 p-8 text-center">
            <h1 className="text-2xl md:text-3xl font-serif font-bold text-volt-400 mb-2">Claim {shop.name}</h1>
            <p className="text-coffee-100 opacity-80">Verify ownership to manage this listing.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label className="block text-sm font-bold text-coffee-900 mb-2">Business Email</label>
                    <input
                        type="email"
                        required
                ...
                <div>
                    <label className="block text-sm font-bold text-coffee-900 mb-2">Your Role</label>
                    <select 
                        className="w-full px-4 py-3 bg-coffee-50 border border-coffee-200 rounded-xl focus:ring-2 focus:ring-volt-400 outline-none"
                        value={formData.role}
            ...
            <div>
                <label className="block text-sm font-bold text-coffee-900 mb-2">Official Social Media Link</label>
                ...
                <p className="text-xs text-coffee-500 mt-2">
                    We use this to verify your connection to the shop. Make sure the account is public or lists your business email.
                </p>
            </div>
            ...
            <div className="bg-volt-400/10 border border-volt-400/30 p-4 rounded-xl flex gap-3">
                ...
                <div className="text-sm text-coffee-800">
                    ...
                    <p>An admin will review your link. Once verified (usually within 24h), you'll get the <i className="fas fa-certificate text-coffee-900"></i> badge and editing rights.</p>
                </div>
            </div>
