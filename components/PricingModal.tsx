        ...
        >
            ...
            >
                ...
                <div className="flex-1 p-8 md:p-12 border-b md:border-b-0 md:border-r border-coffee-50 bg-coffee-50/30 flex flex-col">
                    <div className="mb-8">
                        <span className="bg-coffee-100 text-coffee-800 text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest border border-coffee-100">Basic</span>
                        <h2 className="text-4xl font-serif font-black mt-4 mb-2 text-coffee-900">Owner</h2>
                        <p className="text-coffee-800 text-sm leading-relaxed font-medium">Claim your spot, get verified, and manage the essentials.</p>
                    </div>
                    ...
                    <ul className="space-y-4 mb-10 flex-1">
                        {[
                            ...
                            <li key={i} className="flex gap-3 text-sm text-coffee-800 font-medium">
                                <span className="text-coffee-800 shrink-0"><i className="fas fa-check-circle"></i></span>
                                {feature}
                            </li>
                        ))}
                    </ul>

                    <button disabled className="w-full py-4 rounded-2xl border-2 border-coffee-100 font-bold text-coffee-800 cursor-not-allowed transition-all">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="bg-coffee-50 p-1.5 rounded-2xl inline-flex mb-10 w-full border border-coffee-100">
                            <button
                                ...
                                className={`flex-1 py-2.5 px-4 rounded-xl text-xs font-black transition-all duration-300 ${billingCycle === 'monthly' ? 'bg-white shadow-xl shadow-coffee-900/5 text-coffee-900' : 'text-coffee-800 hover:text-coffee-900'}`}
                            >
                                Monthly
                            </button>
                            <button
                                onClick={() => setBillingCycle('annual')}
                                className={`flex-1 py-2.5 px-4 rounded-xl text-xs font-black transition-all duration-300 relative ${billingCycle === 'annual' ? 'bg-white shadow-xl shadow-coffee-900/5 text-coffee-900' : 'text-coffee-800 hover:text-coffee-900'}`}
                            >
                                Annual Payment
                            </button>
                        </div>
                        ...
                        <div className="mb-10 text-coffee-900">
                            <div className="flex items-baseline gap-2">
                                ...
                                <span className="text-coffee-800 font-bold text-lg">
                        ...
                        <ul className="grid grid-cols-1 gap-3.5 mb-10 flex-1">
                            {[
                                { icon: "fa-calendar", label: "Event Management", sub: "Host tastings & workshops" },
                                ...
                                { icon: "fa-music", label: "Vibe Setter", sub: "Spotify playlist integration" },
                                ...
                                <li key={i} className="flex gap-3.5 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-coffee-800 font-medium tracking-wide uppercase">{f.sub}</p>
                                    </div>
                                </li>
                            ))}
                        </ul>
                        ...
                        <p className="text-center text-[10px] text-coffee-800 font-bold uppercase tracking-widest mt-5">
                ...
                <button onClick={onClose} className="hidden md:block absolute top-8 right-8 text-coffee-800 hover:text-coffee-900 transition-colors z-[160]">
